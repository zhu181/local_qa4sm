...
- Env: `QA4SM_MAX_PARALLEL_WORKERS` (default = min(2, CPU count)), `QA4SM_HEARTBEAT_INTERVAL_SECONDS` (default 60), `QA4SM_USE_GPU`, `QA4SM_DASK_MEMORY_LIMIT` (total budget for all workers, e.g. "16GB"; divided equally per worker; default 4GB per worker)
